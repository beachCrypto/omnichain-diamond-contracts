...
*/
contract LZEndpointMockA is ILayerZeroEndpoint {
    ...
    function send(
        ...
        address lzEndpoint = 0x5FbDB2315678afecb367f032d93F642f64180aa3;
        ...
        LZEndpointMockA(lzEndpoint).receivePayload(mockChainId, srcUaAddress, dstAddr, nonce, extraGas, payload);
    }
